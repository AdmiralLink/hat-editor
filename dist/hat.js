(function () {
  ...
  var DomEl = function DomEl(creationString) {
      ...
      if (this.attributes && this.attributes.length > 0) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var attributeString = _step2.value;
  ...
  var Hat = function Hat(containerEl) {
    var Blocks = [];
    var BlockCount = 0;
    var Elements = {
      blockHolder: false,
    ...
    var Events = {
      fire: function fire(eventName) {
        var element = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Elements.blockHolder;
        element.dispatchEvent(new Event(eventName));
      }
    };
    var Internal = {
      blockCount: 0,
      insertAddBlockButton: function insertAddBlockButton() {
      ...
      initialize: function initialize(containerEl) {
      ...
      manageSorting: function manageSorting() {
        Internal.sorting = Sortable.create(Elements.blockHolder, {
          animation: 150,
          group: 'blocks',
    ...
    var Interface = {
      addBlock: function addBlock() {
        ...
        var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'paragraph';
        var blockClass = window.HatRack.get_block(type);
        var block = new blockClass(this);
      ...
      getBlockContainer: function getBlockContainer() {
        return Elements.blockHolder;
      },
      getBlockPosition: function getBlockPosition(blockEl) {
        var blocks = Elements.blockHolder.querySelectorAll('.block');
        var position = {
          count: BlockCount
        };
  ...
  var Block = /*#__PURE__*/function () {
    ...
    _createClass(Block, [{
      ...
      value: function addGlobalEvents() {
        ...
        var blockContainer = this.editor.getBlockContainer();
      ...
      value: function blockRegistration() {}
    }, {
      key: "checkBlockSettingsControls",
      value: function checkBlockSettingsControls() {
        var position = this.editor.getBlockPosition(this.el);
        var up = this.upButton;
        var down = this.downButton;
        var grip = this.moveButton;
      ...
      key: "checkKeyboardShortcuts",
      value: function checkKeyboardShortcuts() {
        if (this.keysDown.length > 1) {
          var keys = this.keysDown.sort(function (a, b) {
            return a < b ? -1 : 1;
          });

          if (this.keyboardShortcuts.hasOwnProperty(keys[0])) {
            var primaryKey = this.keyboardShortcuts[keys.shift()];
      ...
      key: "registerGlobalKeyboardShortcuts",
      value: function registerGlobalKeyboardShortcuts() {
        var element = this;
      ...
      value: function registerKeyboardShortcut(keys, actionToCall) {
      ...
      value: function registerSettings() {}
    }, {
      key: "setup",
  ...
  var ParagraphBlock = /*#__PURE__*/function (_Block) {
    ...
    var _super = _createSuper(ParagraphBlock);
  ...
  window.HatRack = function () {
    ...
    var Interface = {
      get_block: function get_block(blockName) {
      ...
      has_block: function has_block(blockName) {
        return BlockRegistry.names.indexOf(blockName) > -1;
      },
      register_block: function register_block(name, slug, blockObj) {
        BlockRegistry.names.push(slug);
        BlockRegistry.objects[slug] = blockObj;
      },
      start: function start() {
        var querySelector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '.hat-editor';

        var _iterator = _createForOfIteratorHelper(document.querySelectorAll(querySelector)),
            _step;
